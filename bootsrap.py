...
class PoseClassificationVisualizer(object):
  ...
  def __call__(self,
    ...
    #pose_confidence = pose_classification[self._class_name]
    max_confidence = 0
    max_confidence = max(pose_classification_filtered.values())
    if max_confidence > 5:
        pose_max_confidence = max(pose_classification_filtered, key=pose_classification_filtered.get)
        self._pose_prev_max = pose_max_confidence
    else:
         pose_max_confidence = self._pose_prev_max
    ...
    # Draw the count.
    if pose_max_confidence == 'CU':
        pose_color = 'blue'
    elif pose_max_confidence == 'FF':
        pose_color = 'red'
    else:
        pose_color = 'yellow'
...
bootstrap_images_in_folder = 'pose_img_in'
# Output folders for bootstrapped images and CSVs.
bootstrap_images_out_folder = 'pose_img_out'
bootstrap_csvs_out_folder = 'pose_csv_out'
...
video_path = 'ff_test01.mp4'
class_name='FF'
out_video_path = 'ff_test01_out.mp4'
...
pose_samples_folder = 'pose_csv_out'
